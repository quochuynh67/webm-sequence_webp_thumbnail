...
#                    ffmpeg -c:v libvpx-vp9 -i "$file" -vf scale=134:134 -frames:v 60 -loop 0 -c:v libwebp -y "$sub_folder11"/$file_name".webp"
                ...
                ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=30,scale=iw/3:ih/3 "$sub_folder11"/$file_name".webp"
...
#                        ffmpeg -c:v libvpx-vp9 -i "$file" -vf scale=134:134 -frames:v 60 -loop 0 -c:v libwebp -y "$sub_folder11"/$file_name" 11.webp"
                ...
                ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=30,scale=134:134 "$sub_folder11"/$file_name" 11.webp"
                ;;
...
#                        ffmpeg -c:v libvpx-vp9 -i "$file" -vf scale=240:134  -frames:v 60 -loop 0 -c:v libwebp -y "$sub_folder11"/$file_name" 169.webp"
                        ...
                        ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=30,scale=240:134 "$sub_folder11"/$file_name" 169.webp"
                ;;
...
#
                ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=30,scale=134:240 "$sub_folder11"/$file_name" 916.webp"
                ;;
...
#                        ffmpeg -c:v libvpx-vp9 -i "$file" -vf scale=134:134 -frames:v 60 -loop 0 -c:v libwebp -y "$sub_folder11"/$file_name" 11.webp"
                    ...
                    ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=30,scale=96:96 "$sub_folder11"/$file_name" 11.webp"
...
#                frameFolderPathInput=`pwd`'/titles_webm/Title_*.webm'
                frameFolderPathInput=`pwd`'/titles_webm/Subtitle_*.webm'
                echo "Sticker folder path: $frameFolderPathInput"
...
#                ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=60,scale=240:134 "$sub_folder11"/$file_name".webp"
                ffmpeg -c:v libvpx-vp9 -i "$file" -vf fps=30,scale=iw/2:ih/2 "$sub_folder11"/$file_name".webp"
